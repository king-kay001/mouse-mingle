<?php
define('OW_URL_HOME', 'https://staging.peatechllc.com/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'wecilo');
define('OW_DB_PASSWORD', 'mbaise2020');
define('OW_DB_NAME', 'peatech_sk_mousemingle');
...
define('OW_PASSWORD_SALT', '64cedc3651a69');
...
else
{
    ...
    */
    ...
    define('OW_DEBUG_MODE', !isset($_GET['debug']));
    define('OW_DEV_MODE', isset($_GET['dmode']));
